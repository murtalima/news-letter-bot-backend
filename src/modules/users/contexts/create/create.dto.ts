...
export class CreateUserDto {
  @ApiProperty({ type: String, required: true, nullable: false, example: 'Gabriel Lima' })
  @IsNotEmpty()
  @IsString()
  name: string;

  @ApiProperty({ type: String, required: true, nullable: false, example: '360209386682974208' })
  @IsNotEmpty()
  @IsString()
  discordId: string;
